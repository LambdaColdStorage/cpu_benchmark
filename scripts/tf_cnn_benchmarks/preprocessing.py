...
def distort_image(image, height, width, bbox, thread_id=0, scope=None, distort=False):
...
class ImagePreprocessor(object):
  ...
  def preprocess(self, image_buffer, bbox, thread_id):
    ...
    if self.train and self.distortions:
      image = distort_image(image, self.height, self.width, bbox, thread_id, None, True)
    else:
      image = distort_image(image, self.height, self.width, bbox, thread_id, None, False)
