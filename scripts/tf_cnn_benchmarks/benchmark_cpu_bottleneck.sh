...
# for NUM_GPU in 4
# do
#   for UPDATE_MODE in parameter_server replicated
#   do
#     for DISTORTIONS in True False
#     do
#       echo ${CPU_NAME}_${MODEL}_syn_bs_${BATCH_SIZE}_gpu_${NUM_GPU}_distortions_${DISTORTIONS}_update_${UPDATE_MODE}
...
#       &> ${CPU_NAME}_${MODEL}_syn_bs_${BATCH_SIZE}_gpu_${NUM_GPU}_distortions_${DISTORTIONS}_update_${UPDATE_MODE}.log
#     done
#   done
# done
...
#     for DISTORTIONS in True False
#     do
#       echo ${CPU_NAME}_${MODEL}_real_bs_${BATCH_SIZE}_gpu_${NUM_GPU}_distortions_${DISTORTIONS}_update_${UPDATE_MODE}
#       python tf_cnn_benchmarks.py \
#       --num_gpus=$NUM_GPU \
#       --batch_size=$BATCH_SIZE \
#       --model=$MODEL \
...
#       --num_batches=$NUM_BATCHES \
#       --data_dir=$DIR_DATA \
#       &> ${CPU_NAME}_${MODEL}_real_bs_${BATCH_SIZE}_gpu_${NUM_GPU}_distortions_${DISTORTIONS}_update_${UPDATE_MODE}.log
#     done
#   done
# done
